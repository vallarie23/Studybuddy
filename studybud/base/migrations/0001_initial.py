    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hosted_rooms', to='base.user')),
                ('participants', models.ManyToManyField(blank=True, related_name='joined_rooms', to='base.user')),
            ],
            options={
